...
enum NodeType {
  ...
  DOCUMENT_POSITION_DISCONNECTED = 0x01 satisfies typeof Node.DOCUMENT_POSITION_DISCONNECTED,
  DOCUMENT_POSITION_PRECEDING = 0x02 satisfies typeof Node.DOCUMENT_POSITION_PRECEDING,
  DOCUMENT_POSITION_FOLLOWING = 0x04 satisfies typeof Node.DOCUMENT_POSITION_FOLLOWING,
  DOCUMENT_POSITION_CONTAINS = 0x08 satisfies typeof Node.DOCUMENT_POSITION_CONTAINS,
  DOCUMENT_POSITION_CONTAINED_BY = 0x10 satisfies typeof Node.DOCUMENT_POSITION_CONTAINED_BY,
  DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC = 0x20 satisfies typeof Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC,
}
